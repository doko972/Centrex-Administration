...
<div class="card" style="max-width: 800px;">
    ...
    <form method="POST" action="{{ route('admin.clients.update', $client) }}">
        ...
        <div style="margin-bottom: 1rem;">
            ...
            <small style="color: var(--text-tertiary);">Laisser vide si vous ne souhaitez pas le modifier. Min. 8 caractères, majuscule, minuscule, chiffre et caractère spécial.</small>
        </div>
