...
<div class="page-header" style="margin-bottom: 1rem;">
    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
        <div style="display: flex; align-items: center; gap: 1rem;">
            <a href="{{ route('admin.ipbx.show', $ipbx) }}" class="btn btn-outline btn-sm">Retour</a>
            <div>
        ...
        <a href="{{ route('admin.ipbx.proxy.root', $ipbx) }}" target="_blank" class="btn btn-outline btn-sm">
...
<div class="card" style="padding: 0; overflow: hidden; height: calc(100vh - 220px); min-height: 500px;">
    <iframe
        id="ipbx-iframe"
        src="{{ route('admin.ipbx.proxy.root', $ipbx) }}"
