...
<div class="page-header" style="margin-bottom: 1rem;">
    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
        <div style="display: flex; align-items: center; gap: 1rem;">
            <a href="{{ route('admin.centrex.index') }}" class="btn btn-outline btn-sm">← Retour</a>
            <div>
        ...
        <div style="display: flex; gap: 0.5rem;">
            <a href="{{ route('admin.centrex.edit', $centrex) }}" class="btn btn-outline btn-sm">
                Modifier les infos
            </a>
            <a href="{{ route('admin.centrex.proxy.root', $centrex) }}" target="_blank" class="btn btn-outline btn-sm">
...
<div class="card" style="padding: 0; overflow: hidden; height: calc(100vh - 220px); min-height: 500px;">
    <iframe
        id="centrex-iframe"
        src="{{ route('admin.centrex.proxy.root', $centrex) }}"
